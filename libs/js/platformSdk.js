...
;(function(window) {
    ...
    var nonMsgClasses = {
        bridgeClass1: {
            ...
            allowUpPress: function (allowUp) {
                if (PlatformBridge.allowUpPress) {
                    PlatformBridge.allowUpPress(allowUp);
                } else {
                    if (console) console.log("function not available");
                }
            },
            ...
            sendEmail: function (params) {
                if (PlatformBridge.sendEmail) {
                    PlatformBridge.sendEmail(params.subject || '', params.body || '', params.to || '');
                } else {
                    if (console) {
                        console.log("function not available");
                    }
            ...
            setStatusBarColor: function (params) {
                if (PlatformBridge.setStatusBarColor) {
                    PlatformBridge.setStatusBarColor(params.hexColor);
                } else {
                    if (console) {
                        console.log("function not available");
                    }
